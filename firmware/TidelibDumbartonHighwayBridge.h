/*  TidelibDumbartonHighwayBridge.h 
  A library for calculating the current tide height at 
   Dumbarton Highway Bridge, San Francisco Bay, California , NOAA station ID number  
...
class TideCalc {
 public:
	 TideCalc();
    float currentTide(time_t now); // returns predicted tide for
